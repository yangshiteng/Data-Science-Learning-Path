...
### [Knowledge Point](https://github.com/yangshiteng/StatQuest-Study-Notes/blob/main/Notes/Ensemble%20Learning%20Knowledge%20Points.md)
...
### 2.7.2 AdaBoost (Ensemble Leanring - Boosting) (model tranining based on sample weights from previous model)
...
### 2.7.4 XGBoost (an implementation of Gradient Boosting designed for computational speed)
