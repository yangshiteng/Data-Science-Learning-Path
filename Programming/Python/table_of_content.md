...
* Python Data Type - String
  * [Multi-line string](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_data_type/multi_line_string.md)
  * [String Concatenation](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_data_type/string_contact.md)
  * [String Methods](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_data_type/string_methods.md)
  * [String Formatting](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_data_type/stringformat.md)
  * [String Escape Character (allow the illegal character in a string)](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_data_type/escape_character.md)
  * [String Reverse](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_data_type/string_reverse.md)
  * [Regular Expression (re module)](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_data_type/regular_expression.md)
* Python Data Type - List 
  * [List Introduction](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/list_introduction.md)
  * [List Change Items](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/List_Change_Items.md)
  * [List Add Items](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/listadditems.md)
  * [List Remove Items](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/list_remove.md)
  * [List Comprehension (one line list loop)](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/list_comprehension.md)
  * [List Sort (customized sort rule)](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/list_sort.md)
  * [List Copy](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/list_copy.md)
  * [List Index (Return the index of the first element with the specified value)](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/list_index.md)
   * [Multiply List](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/Multiply_List.md)
   * [List Count](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/List_count.md)
   * [List Concatenation](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/Programming/Python/python_list/list_concatenation.md)
