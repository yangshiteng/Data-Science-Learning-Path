...
- **1. Linear Regression**
  ...
  - Regularization (handle overfitting)
    - [Regularization (LASSO, feature selection) (Ridge, handle multicollinearity and improve model stability) (Elastic Net, feature selection, handle multicollinearity and improve model stability)](https://github.com/yangshiteng/Data-Science-Learning-Path/blob/main/statistics/regression/regularization_summary.md)
