...
* [Python - Class](https://github.com/yangshiteng/StatQuest-Study-Notes/blob/main/python/python%20class.md)
  ...
  * [Class Method (针对于类的方法)](https://github.com/yangshiteng/StatQuest-Study-Notes/blob/main/python/python%20classmethod.md)
  * [Instance Method （针对于对象的方法）](https://github.com/yangshiteng/StatQuest-Study-Notes/blob/main/python/instance%20method.md)
  ...
  * [Magic Method (also called Dunder Method) (it is a special instance method with double underscores before and after the method name)](https://github.com/yangshiteng/StatQuest-Study-Notes/blob/main/python/magic%20method.md)
