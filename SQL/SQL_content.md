...
## 1. Select (which column)
  ...
  * [Concatenate Multiple rows into a single string](https://github.com/yangshiteng/StatQuest-Study-Notes/blob/main/SQL/Multiperow%20to%20one%20row.md)
## 2. From (which table) 
...
## 6. Order By (which column)
  ...
  * [Order by multiple columns](https://github.com/yangshiteng/StatQuest-Study-Notes/blob/main/SQL/Orderbymultilecolumns.md)
## 7. limit & offset
