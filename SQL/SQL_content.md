...
## 1. Select (which column)
  ...
  * [Create a new column by Null Functions (IFNULL, ISNULL, COALESCE) ](https://github.com/yangshiteng/StatQuest-Study-Notes/blob/main/SQL/NullFunctions.md)
  * [Create a new column by SQL Arithmetic Operators](https://github.com/yangshiteng/StatQuest-Study-Notes/blob/main/SQL/SQL%20Arithmetic%20Operators.md)
## 2. From (which table) 
...
## 4. Copy data from one table to a new table
